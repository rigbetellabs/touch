...
echo "[Note] Catkin workspace   >>> $HOME/rigbetel_ws"
echo ""
...
name_catkin_workspace=${name_catkin_workspace:="rigbetel_ws"}
...
git clone https://github.com/rigbetellabs/touch.git
